                ...
                <div class="col-12">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Top 100 Scores by Players</h3>
                            <h6 class="box-subtitle">All the data are from central server</h6>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="table-responsive">
                                <table id="example" class="table table-bordered table-hover display nowrap margin-top-10 margin-bottom-10 w-p100c">
                                    <br>
