...
class _Segment1State extends State<Segment1> {
  ...
  quiz(String grp) async{
    ...
    QUESTIONS_J.quiz_seg1_junior:grp=="yth"? QUESTIONS_Y.quiz_seg1_youth: QUESTIONS_S.quiz_seg1_senior, 6);
    print(randomQsn);
...
//Qsn wise answer:: randomQsn[QSN_INDEX][2]
  ...
  Future saveAns() async {
    ...
    SharedPreferences preferences = await SharedPreferences.getInstance();
    preferences.setString('seg1_ans', jsonEncode(answers));


    Fluttertoast.showToast(
        msg: "১ম বিভাগ সম্পন্ন হয়েছে",
        toastLength: Toast.LENGTH_SHORT,
        gravity: ToastGravity.BOTTOM,
        backgroundColor: Colors.green,
        textColor: Colors.white,
        fontSize: 16.0);
    final yourStr = preferences.getString("seg1_ans");
    print("saved 1: ${yourStr}");
  }
