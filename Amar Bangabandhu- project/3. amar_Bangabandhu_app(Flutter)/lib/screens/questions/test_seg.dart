...
class testseg extends StatefulWidget {
  @override
  _testsegState createState() => _testsegState();
}

class _testsegState extends State<testseg> {
  ...
  quiz() {
// Random 3 Qsn--
    randomQsn = pickRandomItemsAsList(QUESTIONS_J.quiz_seg1_junior, 6);
    print(randomQsn);
...
//Qsn wise answer:: randomQsn[QSN_INDEX][2]
  ...
  Future saveAns() async {
        ...
        preferences.setString('pr_ans', jsonEncode(answers));
        ...
        Fluttertoast.showToast(
            ...
            fontSize: 16.0);
        final yourStr = preferences.getString("pr_ans");
        print("saved: ${yourStr}");
  }
            ...
            RaisedButton(
              onPressed: () async {
                ...
                _stopWatchTimer.rawTime.listen((value) async {
                  print(
                      'QSN 1============== $value ${StopWatchTimer.getDisplayTime(value)}');
                  SharedPreferences preferences =
                      await SharedPreferences.getInstance();
                  preferences.setString(
                      'QS1', '${StopWatchTimer.getDisplayTime(value)}');
                });
