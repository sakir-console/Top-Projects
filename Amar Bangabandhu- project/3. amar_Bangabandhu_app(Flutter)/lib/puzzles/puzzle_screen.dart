...
/*
    ...
    // _stopWatchTimer.setPresetTime(mSec: 8734);
  }
    ...
    await Future.delayed(new Duration(milliseconds: 100), () {
      showDialog(
          ...
          builder: (_) => AssetGiffyDialog(
                ...
                title: Text(
                  'ধাপ- ${widget.step <= 12 ? bnToen(widget.step) :(13 <= widget.step && widget.step <= 19 )? bnToen(widget.step - 1) : ( widget.step>=20 && widget.step <= 26) ? bnToen(widget.step - 2) : bnToen(widget.step - 3)}',
                  style: TextStyle(
                      color: Colors.pink,
                      fontFamily: 'SolaimanLipi',
                      fontSize: 38),
  ...
  Future askBefore() async {
    ...
    await showCupertinoDialog(
        ...
        builder: (context) => CupertinoAlertDialog(
              title: const Text('নতুন আরেকটি ধাপ বাছাই?',
                  style: TextStyle(
