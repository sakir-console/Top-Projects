...
class _Segment4State extends State<Segment4> {
  ...
  quiz(String grp) async{
    ...
    QUESTIONS_J.quiz_seg4_junior:grp=="yth"?QUESTIONS_Y.quiz_seg4_youth:QUESTIONS_S.quiz_seg4_senior, 6);
    print(randomQsn);
...
//Qsn wise answer:: randomQsn[QSN_INDEX][2]
  ...
  Future saveAns() async {
    ...
    preferences.setString('seg4_ans', jsonEncode(answers));


    Fluttertoast.showToast(
        msg: "৪র্থ বিভাগ সম্পন্ন হয়েছে",
        toastLength: Toast.LENGTH_SHORT,
        gravity: ToastGravity.BOTTOM,
        backgroundColor: Colors.green,
        textColor: Colors.white,
        fontSize: 16.0);
    final yourStr = preferences.getString("seg4_ans");
    print("saved 4: ${yourStr}");
  }
