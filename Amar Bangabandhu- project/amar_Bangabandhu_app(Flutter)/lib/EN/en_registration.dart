...
import 'EnSignIn.dart';
import 'en_home.dart';


class EnRegistrationScreen extends StatefulWidget {
  @override
  _EnRegistrationScreenState createState() => _EnRegistrationScreenState();
}

class _EnRegistrationScreenState extends State<EnRegistrationScreen> {
  ProgressDialog pr;
  ...
  Future signUp() async {
    ...
    if (data['result'] == true) {
      ...
      Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(
            builder: (context) => const EnHomeScreen(),
          ),
          (route) => false);
  ...
  List<Gender> genders = <Gender>[
    ...
    const Gender(3, 'Others', 'অন্যান্য'),
  ];

  List<GrdnProf> grdnProfs = <GrdnProf>[
    const GrdnProf(
        null, 'Own/Guardian Profession ', 'অবিভাবকের কর্মক্ষেত্র নির্বাচন'),
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(
                  'Enter the correct Birth Certificate/NID No. to get your prizes(in English)',
              ...
              Padding(
                padding: EdgeInsets.only(left: 8, right: 8),
                child: Text(
                  'Mobile number will be used for further communication and OTP code.',
                  style: GoogleFonts.ubuntu(fontSize: 9),
                ),
              ),
              ...
              Padding(
                padding: EdgeInsets.only(left: 8, right: 8),
                child: Text(
                  'Choose the correct birth year to Participate in exact group (Junior, Youth, Senior) ',
                  style: GoogleFonts.ubuntu(fontSize: 9),
                ),
              ),
              ...
              Padding(
                padding: EdgeInsets.only(left: 8, right: 8),
                child: Text(
                  'Must remember your PIN for next extrance',
              ...
              Padding(
                padding: EdgeInsets.only(left: 8, right: 8),
                child: Text(
                  'Write down the name of the way or person by whom you know the app.',
                  style: GoogleFonts.ubuntu(fontSize: 9),
                ),
              ),
              ...
              OutlineGradientButton(
                ...
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => EnSignInScreen()));
                },
                onDoubleTap: () => null,
                onLongPress: () => null,
              ),
